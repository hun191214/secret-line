...
exports.profitService = exports.ProfitService = void 0;
const client_1 = require("@prisma/client");
class ProfitService {
    prisma;
    constructor() { this.prisma = new client_1.PrismaClient(); }
    async settleTransaction(params) {
        ...
        // 왕관 등급 업데이트 (정산 후)
        const { userService } = await Promise.resolve().then(() => __importStar(require('../user/user.service')));
...
exports.profitService = new ProfitService();
